...
class AnggotaController extends Controller
{
    ...
    // Update Anggota dengan Validasi
    ...
    // Pertemuan 13 - Fungsi untuk generate kode anggota otomatis
    ...
    // Pertemuan 13 - Export data anggota ke Excel
    public function export()
    {
        return Excel::download(new AnggotaExport, 'anggota_' . date('Y-m-d_His') . '.xlsx');
    }

    // Pertemuan 13 - Fungsi search anggota
